	...
	<div class="content">
		...
		<div class="grid">
			<div class="grid-title">
				<div class="pull-left">New contact</div>
					<div class="pull-right"></div>
					<div class="clear"></div>
			</div><!-- end grid title -->
			<div class="grid-content">
				<form action="/systemsettings/contacts/savecontact" method="post">
					<div class="formRow">
						<label>Name </label>
						<div class="formRight">
					...
					<div class="formRow">
						...
						<div class="formRight">
				        	 <select class="span_select" name="catagoryid">
				        	 	<?php foreach ($contactcategory as $value) {
					...
					<div class="formRow">
			         ...
			         <div class="formRow">
						<div class="formRight">
			     			<input class="btn btn-warning" type="Submit" value="Save contact">
			     		</div>
		     		</div>
	 				<div class="clear"></div>
				</form>
