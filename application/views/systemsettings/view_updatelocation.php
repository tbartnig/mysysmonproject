	...
	<div class="content">
		...
		<div class="grid">
			<div class="grid-title">
				<div class="pull-left">Update location</div>
					<div class="pull-right"></div>
					<div class="clear"></div>
			</div><!-- end grid title -->
			<div class="grid-content">
				<form action="/systemsettings/locations/updatelocation" method="post">
					<div class="formRow">
					...
					<div class="formRow">
						<div class="formRight">
							<input type="hidden" id="idlocation" name="idlocation" value="<?=$values['idlocation'] ?>"  class="span">
			     			<input class="btn btn-warning" type="Submit" value="Update location">
			     		</div>
		     		</div>
